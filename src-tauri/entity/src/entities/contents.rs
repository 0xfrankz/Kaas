...
use sea_orm::{entity::prelude::*, ActiveValue::{self, NotSet}, IntoActiveModel, IntoActiveValue};
use serde::{Deserialize, Serialize};
use serde_repr::{Serialize_repr, Deserialize_repr};

#[derive(Clone, Default, Debug, PartialEq, EnumIter, DeriveActiveEnum, Eq, Serialize_repr, Deserialize_repr)]
